...
public class MainController {
	 ...
	 * "This page is for ROLE_ADMIN only!"); model.setViewName("admin");
	 * 
	 * return model;
	 * 
	 * }
	 ...
	 * 
	 * String error = ""; if (exception instanceof BadCredentialsException) {
	 * error = "Invalid username and password!"; } else if (exception instanceof
	 * LockedException) { error = exception.getMessage(); } else { error =
